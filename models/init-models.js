...
var Xabar = _Xabar(sequelize, DataTypes);
...
Xabar.belongsTo(User, { as: "sender", foreignKey: "sender_id" });
User.hasMany(Xabar, { as: "sender", foreignKey: "sender_id" });
// Room.hasMany(Xabar, {
//   as: "xabar",
//   foreignKey: "room_id",
// });
Room.belongsTo(User, { as: "user", foreignKey: "receiverId" });
User.hasMany(Elon, { as: "elon", foreignKey: "user_id" });
module.exports = {
  Category,
  CategoryFieldDoc,
  CategoryFields,
