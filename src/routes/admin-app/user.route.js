...
router.post('/create', awaitHandlerFactory(userController.create));
router.patch('/reset', awaitHandlerFactory(userController.reset));
router.patch('/update/:id', auth(), awaitHandlerFactory(userController.update));
router.delete(
	'/delete/:id',
	auth(),
	awaitHandlerFactory(userController.delete)
);
router.get('/all', auth(), awaitHandlerFactory(userController.getAll));
router.get('/person', auth(), awaitHandlerFactory(userController.person));
